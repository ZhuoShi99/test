...
public class MoreActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proIv = findViewById(R.id.profile);
...
//                获取目前的默认壁纸
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.more_tv_share:
                shareSoftwareMsg("weather_forecast是一款很实用的天气预报软件，画面简洁，天气情况精准，快来下载吧！");
                break;
    ...
    private void shareSoftwareMsg(String s) {
        ...
        startActivity(Intent.createChooser(intent,"weather_forecast"));
    }
